...
import { Button, Divider, IndexPath, Input, Select, SelectItem, StyleService, Tab, TabView, Text, TopNavigation, TopNavigationAction, useStyleSheet } from '@ui-kitten/components';
...
import { movSucataUpdateSchema } from './schemas';
...
export default ({ navigation, route }): React.ReactElement => {
  ...
  return (
    <>
      <TopNavigation
        title='ALTERAR ENVIO PARA SUCATA'
            ...
            <>
              ...
              <SafeAreaLayout
                ...
                <Input
                  ...
                  value={getSucataLocal(model.SucataLocal)}/>  
