...
import { consertoPneuServicoInsertSchema } from '../schemas';
...
interface Params {
    pneu: IPneu;
    onHandleSave: (servico: IConsertoPneuServico) => void;
}
...
export default ({ navigation, route }): React.ReactElement => {
    ...
    const [model, setModel] = React.useState<IConsertoPneuServico>({Pneu: param.pneu, Quant: 0, ValorUnit: 0, ValorTotal: 0} as IConsertoPneuServico);
    ...
    async function handleSave(item: IConsertoPneuServico) {
        try{    
            setIsLoading(true);
    ...
    const formik = useFormik({
        ...
        validationSchema: consertoPneuServicoInsertSchema,
